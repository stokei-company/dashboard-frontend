...
export const removeToken = (ctx?: any) => nookies.destroy(ctx, COOKIE_TOKEN_NAME, {
    domain: cookieDomain,
});

export const setToken = (value: string, ctx?: any) => nookies.set(ctx, COOKIE_TOKEN_NAME, value, {
